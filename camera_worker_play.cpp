...
void camera_worker_play::initlib()
{
    static QMutex mutex;
...
void camera_worker_play::setUrl(const QString &url)
{
    this->url = url;
}

void camera_worker_play::free()
{
    if (swsContext != NULL) {
